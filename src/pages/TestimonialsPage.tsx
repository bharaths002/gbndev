...
import Navbar from "../components/Navbar"; // ← ArrowLeft import removed
...
export default function TestimonialsPage() {
  ...
  return (
    <div className="bg-bone min-h-screen text-obsidian selection:bg-amber-100 selection:text-amber-900 relative">
      ...
      {/* ── HERO BANNER ────────────────────────────────────────────────────── */}
      <section className="pt-8 pb-12 md:pt-28 md:pb-20 text-center max-w-3xl mx-auto px-6 border-b border-black/5">
      ...
      <a  href="https://wa.me/919360460661?text=Greetings%20from%20Glassbones!%20What%20can%20we%20help%20you%20with%3F"
        target="_blank"
